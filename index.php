<?php
    $faqs = [
        ...
        [
            ...
            'solution' => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.
        ...
        [
            ...
            'solution' => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:
...
<body>
    ...
    <main>
        <div class="container">
            ...
            foreach($faqs as $faq) {
            ?>
            <h1 class="title"> <?php echo $faq['quest']; ?> </h1>
            <span class="text"> <?php echo $faq['solution']; ?> </span>
            <?php } ?>
        </div>
    </main>
</body>
